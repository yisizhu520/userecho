...
down_revision: Union[str, None] = '20251231a'
...
def upgrade() -> None:
    ...
    op.create_table(
        'tenant_user_roles',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('tenant_user_id', sa.String(36), sa.ForeignKey('tenant_users.id', ondelete='CASCADE'), nullable=False),
    ...
    op.add_column('feedbacks', sa.Column('board_id', sa.String(36), sa.ForeignKey('boards.id', ondelete='CASCADE'), nullable=True))
    ...
    op.add_column('topics', sa.Column('board_id', sa.String(36), sa.ForeignKey('boards.id', ondelete='CASCADE'), nullable=True))
    op.add_column('topics', sa.Column('tech_lead_id', sa.BigInteger(), sa.ForeignKey('sys_user.id', ondelete='SET NULL'), nullable=True))
