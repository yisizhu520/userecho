...
def upgrade():
    ...
    sa.Column('type', sa.String(length=50), nullable=False, comment='通知类型: topic_completed/notification_pending/feedback_imported/clustering_completed'),
    ...
    sa.Column('notified_at', backend.common.model.TimeZone(timezone=True), nullable=True, comment='标记为已通知的时间'),
    sa.Column('notified_by', sa.BigInteger(), nullable=True, comment='操作人员ID'),
    sa.Column('notification_channel', sa.String(length=50), nullable=True, comment='通知渠道: manual/wechat/email/sms'),
