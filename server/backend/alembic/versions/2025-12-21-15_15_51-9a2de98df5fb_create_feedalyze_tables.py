...
def upgrade():
    ...
    sa.Column('customer_type', sa.String(length=20), nullable=False, comment='客户类型: normal, paid, major, strategic'),
    ...
    sa.Column('category', sa.String(length=20), nullable=False, comment='分类: bug, improvement, feature, performance, other'),
    sa.Column('status', sa.String(length=20), nullable=False, comment='状态: pending, planned, in_progress, completed, ignored'),
