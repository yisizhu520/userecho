...
from backend.app.userecho.model import Board, Customer, Feedback, Topic, Tenant
...
DEMO_CUSTOMERS = [
    {'name': '腾讯游戏', 'customer_type': 'enterprise', 'business_value': 5, 'contact_name': '张三', 'contact_email': 'zhangsan@tencent.com'},
    {'name': '阿里云', 'customer_type': 'enterprise', 'business_value': 5, 'contact_name': '李四', 'contact_email': 'lisi@alibaba.com'},
    {'name': '字节跳动', 'customer_type': 'enterprise', 'business_value': 4, 'contact_name': '王五', 'contact_email': 'wangwu@bytedance.com'},
    {'name': '美团点评', 'customer_type': 'enterprise', 'business_value': 4, 'contact_name': '赵六', 'contact_email': 'zhaoliu@meituan.com'},
    {'name': '小米科技', 'customer_type': 'enterprise', 'business_value': 4, 'contact_name': '钱七', 'contact_email': 'qianqi@xiaomi.com'},
    {'name': '京东商城', 'customer_type': 'enterprise', 'business_value': 4, 'contact_name': '孙八', 'contact_email': 'sunba@jd.com'},
    {'name': '网易有道', 'customer_type': 'enterprise', 'business_value': 3, 'contact_name': '周九', 'contact_email': 'zhoujiu@netease.com'},
    {'name': '哔哩哔哩', 'customer_type': 'enterprise', 'business_value': 3, 'contact_name': '吴十', 'contact_email': 'wushi@bilibili.com'},
    {'name': '创业公司A', 'customer_type': 'startup', 'business_value': 2, 'contact_name': '陈一', 'contact_email': 'chenyi@startup-a.com'},
    {'name': '创业公司B', 'customer_type': 'startup', 'business_value': 2, 'contact_name': '林二', 'contact_email': 'liner@startup-b.com'},
]
...
DEMO_TOPICS = [
    {'title': '数据导出功能优化', 'description': '支持 Excel、PDF 等多种格式导出', 'status': 'new', 'priority_score': 85.5},
    {'title': '首屏加载性能优化', 'description': '优化首屏加载时间，提升用户体验', 'status': 'review', 'priority_score': 92.3},
    ...
    {'title': '消息通知系统', 'description': '支持站内消息、邮件、微信等多渠道通知', 'status': 'approved', 'priority_score': 78.9},
...
async def clear_demo_data() -> None:
    ...
    async with async_db_session.begin() as db:
        ...
        await db.execute(
            delete(Board).where(
                Board.tenant_id == DEFAULT_TENANT_ID,
