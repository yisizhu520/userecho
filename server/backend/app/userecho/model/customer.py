...
class Customer(MappedBase):
    ...
    # 客户分类
    customer_type: Mapped[str] = mapped_column(String(20), default='normal', comment='客户类型: normal, paid, vip, strategic')
    customer_tier: Mapped[str] = mapped_column(String(20), default='normal', comment='客户等级: free, normal, paid, vip, strategic')
    ...
    source: Mapped[str | None] = mapped_column(String(50), default=None, comment='客户来源: direct, referral, marketing')
