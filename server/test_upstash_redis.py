...
async def test_basic_connection() -> bool | None:
    """测试基本连接"""
    print('=' * 60)
    print('🔌 测试 1: 基本连接')
    print('=' * 60)
...
async def test_read_write() -> bool | None:
    """测试读写操作"""
    print('\n' + '=' * 60)
    print('📝 测试 2: 读写操作')
    print('=' * 60)
...
async def test_batch_operations() -> bool | None:
    """测试批量操作"""
    print('\n' + '=' * 60)
    print('📦 测试 3: 批量操作')
    print('=' * 60)
...
async def test_performance() -> bool | None:
    """测试性能"""
    print('\n' + '=' * 60)
    print('⚡ 测试 4: 性能测试')
    print('=' * 60)
...
async def test_plugin_cleanup() -> bool | None:
    """测试插件缓存清理（模拟启动时的操作）"""
    print('\n' + '=' * 60)
    print('🔧 测试 5: 插件缓存清理')
    print('=' * 60)
